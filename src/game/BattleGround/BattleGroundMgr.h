...
class BattleGroundMgr
{
    public:
        ...
        uint32 CreateBattleGround(BattleGroundTypeId bgTypeId, uint32 minPlayersPerTeam, uint32 maxPlayersPerTeam, uint32 levelMin, uint32 levelMax, char const* battleGroundName, uint32 mapId, Position const& team1StartLoc, Position const& team2StartLoc, float startMaxDist, uint32 playerSkinReflootId);
