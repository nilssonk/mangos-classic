    ...
    void WaypointReached(uint32 uiPointId) override
    {
        switch (uiPointId)
        {
            ...
            case 12:
                ...
                m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER, {-7844.3f, -1521.6f, 139.2f, 0.0f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER, {-7860.4f, -1507.8f, 141.0f, 6.0f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_BLACKROCK_RAIDER,   {-7845.6f, -1508.1f, 138.8f, 6.1f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_BLACKROCK_RAIDER,   {-7859.8f, -1521.8f, 139.2f, 6.2f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                break;
            case 24:
                DoScriptText(SAY_SEC_AMBUSH_START, m_creature);
                SetEscortPaused(true);

                m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER,     {-8035.3f, -1222.2f, 135.5f, 5.1f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_FLAMESCALE_DRAGONSPAWN, {-8037.5f, -1216.9f, 135.8f, 5.1f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER,     {-8009.5f, -1222.1f, 139.2f, 3.9f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_FLAMESCALE_DRAGONSPAWN, {-8007.1f, -1219.4f, 140.1f, 3.9f}, TempSpawnType::TIMED_OOC_DESPAWN, 20000);
                break;
            case 28:
                m_creature->SummonCreature(NPC_SEARSCALE_DRAKE, {-7897.8f, -1123.1f, 233.4f, 3.0f}, TempSpawnType::TIMED_OOC_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_SEARSCALE_DRAKE, {-7898.8f, -1125.1f, 193.9f, 3.0f}, TempSpawnType::TIMED_OOC_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_SEARSCALE_DRAKE, {-7895.6f, -1119.5f, 194.5f, 3.1f}, TempSpawnType::TIMED_OOC_DESPAWN, 60000);
                break;
            case 30:
            {
                SetEscortPaused(true);
            ...
            case 45:
                ...
                m_creature->SummonCreature(NPC_HIGH_EXECUTIONER_NUZARK, {-7532.3f, -1029.4f, 258.0f, 2.7f}, TempSpawnType::TIMED_DESPAWN, 40000);
                m_creature->SummonCreature(NPC_SHADOW_OF_LEXLORT,       {-7532.8f, -1032.9f, 258.2f, 2.5f}, TempSpawnType::TIMED_DESPAWN, 40000);
                break;
        }
    }
...
struct npc_klinfranAI : public ScriptedAI
{
    ...
    void DemonDespawn(bool triggered = true)
    {
        ...
        if (triggered)
        {
            Creature* pCleaner = m_creature->SummonCreature(NPC_THE_CLEANER, {m_creature->GetPosition().xyz(), m_creature->GetAngle(m_creature)}, TempSpawnType::DEAD_DESPAWN, 20 * MINUTE*IN_MILLISECONDS);
            if (pCleaner)
            {
