    ...
    void WaypointReached(uint32 uiPointId) override
    {
        switch (uiPointId)
        {
            ...
            case 42:
                ...
                m_creature->SummonCreature(NPC_JAEDENAR_LEGIONNAIRE, {5082.068f, -490.084f, 296.856f, 5.15f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_JAEDENAR_LEGIONNAIRE, {5084.135f, -489.187f, 296.832f, 5.15f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_JAEDENAR_LEGIONNAIRE, {5085.676f, -488.518f, 296.824f, 5.15f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
                break;
            case 44:
                SetRun(false);
                break;
            case 105:
                ...
                break;
            case 106:
                m_creature->SummonCreature(NPC_SPIRT_TREY, {4844.839f, -395.763f, 350.603f, 6.25f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
                break;
            case 107:
...
struct npc_areiAI : public npc_escortAI, private DialogueHelper
{
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        if (uiPointId == 37)
        {
            ...
            m_creature->SummonCreature(NPC_IRONTREE_STOMPER, {6573.321f, -1195.213f, 442.489f, 0.0f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
            m_creature->SummonCreature(NPC_IRONTREE_WANDERER, {6573.240f, -1213.475f, 443.643f, 0.0f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
            m_creature->SummonCreature(NPC_IRONTREE_WANDERER, {6583.354f, -1209.811f, 444.769f, 0.0f}, TempSpawnType::TIMED_OOC_OR_DEAD_DESPAWN, 60000);
        }
    }
